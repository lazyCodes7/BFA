...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, baseWidth, cardinality, stride=1, downsample=None):
        ...
        self.conv1 = quan_Conv2d(inplanes, D*C, kernel_size=1, stride=1, padding=0, bias=False)
        self.bn1 = nn.BatchNorm2d(D*C)
        self.conv2 = quan_Conv2d(D*C, D*C, kernel_size=3, stride=stride, padding=1, groups=C, bias=False)
        self.bn2 = nn.BatchNorm2d(D*C)
        self.conv3 = quan_Conv2d(D*C, planes * 4, kernel_size=1, stride=1, padding=0, bias=False)
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, baseWidth, cardinality, layers, num_classes):
        ...
        self.conv1 = quan_Conv2d(3, 64, 7, 2, 3, bias=False)
